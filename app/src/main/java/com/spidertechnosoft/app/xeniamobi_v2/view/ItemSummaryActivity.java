...
import com.spidertechnosoft.app.xeniamobi_v2.view.adpater.ItemSummaryListAdapter;
...
public class ItemSummaryActivity extends AppCompatActivity {
    ...
    final Runnable mUpdateItemSummaryList = new Runnable() {

        @Override
        public void run() {
            updateItemSummaryList();
        }
   ...
   // PosApiHelper posApiHelper = PosApiHelper.getInstance();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.action_print:
                if(mItemSummaries!=null&& mItemSummaries.size()>0) {
                    ...
                    PrintUtil.getInstance().printItemSummaryReport(fromDateTime,toDateTime,mItemSummaries);
    ...
    public void configView(){
        ...
        mItemSummaryListAdapter=new ItemSummaryListAdapter(mContext,mItemSummaries);

        mLvItemSummaryList=(ListView)findViewById(R.id.lvItemSummaryList);

        mLvItemSummaryList.setAdapter(mItemSummaryListAdapter);

        txtItemSummaryFooterTotal=(TextView)findViewById(R.id.txtItemSummaryFooterTotal);
        ...
        btnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fetchItemSummaryList(fromDate,toDate);
            }
        });
     ...
     */
    protected void fetchItemSummaryList(final String fromDateTime, final String toDateTime) {

        dlgProgress=new ProgressDialog(ItemSummaryActivity.this);
        ...
        Thread t = new Thread() {
            ...
            public void run() {
                ...
                try {
                    ...
                    mItemSummaries.clear();

                    mItemSummaries.addAll(saleService.findItemSummaryList(fromDateTime,toDateTime));
                ...
                mHandler.post(mUpdateItemSummaryList);
            }
        };
        t.start();
    }
    ...
    public void setFooter(){
        ...
        Double total=0.0;
        for(ItemSummary itemSummary:mItemSummaries){
            total+=itemSummary.getItemAmount();
        }
        txtItemSummaryFooterTotal.setText(GeneralMethods.formatNumber(total));
    }
    ...
    protected  void updateItemSummaryList(){
        ...
        mItemSummaryListAdapter.notifyDataSetChanged();

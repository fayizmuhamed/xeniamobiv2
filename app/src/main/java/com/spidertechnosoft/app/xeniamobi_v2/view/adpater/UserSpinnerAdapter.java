...
public class UserSpinnerAdapter extends ArrayAdapter<User> {
    ...
    public UserSpinnerAdapter(Context context, int textViewResourceId, List<User> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        lblSpinnerText.setText(user.getName().toString());

        lblSpinnerText.setTag(user);

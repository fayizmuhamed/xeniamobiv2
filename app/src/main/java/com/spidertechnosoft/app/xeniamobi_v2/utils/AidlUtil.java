...
public class AidlUtil {
    ...
    public void printHeaderText(String content, float size, boolean isBold, boolean isUnderLine) {
        if (woyouService == null) {
            // Toast.makeText(context,R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
     ...
     * 打印文字
     */
    public void printText(String content, float size, boolean isBold, boolean isUnderLine,TextAlignment alignment) {
        if (woyouService == null) {
           // Toast.makeText(context,R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }
        ...
        try {
            ...
            if(alignment!=null){
                woyouService.setAlignment(alignment.getValue(), null);
            }
    ...
    public void printTextWithoutLineWrap(String content, float size, boolean isBold, boolean isUnderLine,TextAlignment alignment) {
        if (woyouService == null) {
            // Toast.makeText(context,R.string.toast_2, Toast.LENGTH_LONG).show();
            return;
        }

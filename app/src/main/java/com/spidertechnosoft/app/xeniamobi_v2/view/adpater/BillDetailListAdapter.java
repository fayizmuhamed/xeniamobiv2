...
public class BillDetailListAdapter extends ArrayAdapter<CartItem> {
    ...
    public interface OrderDetailCallback{
        ...
        void setSelectedItem(int position, CartItem cartItem);
    }

    private OrderDetailCallback mOrderDetailCallback;

    public BillDetailListAdapter(@NonNull Context context, @NonNull List<CartItem> objects, CartOperationCallback mCartOperationCallback, OrderDetailCallback orderDetailCallback) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        btnProductReduceFromCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Double price = cartItem.getItemUnitPrice()==null?0:cartItem.getItemUnitPrice();
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mOrderDetailCallback.setSelectedItem(position,cartItem);
            }
        });
